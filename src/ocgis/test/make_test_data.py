...
OUTDIR = '/home/local/WX/ben.koziol/Dropbox/nesii/project/ocg/python/OpenClimateGIS/src/ocg/test/bin' #: location to write
...
d1l1 = [[1,1,2,2],
        ...
        [3,3,4,4],
        [3,3,4,4]]
VAL_MAN = np.array(d1l1).reshape(1,1,4,4)
